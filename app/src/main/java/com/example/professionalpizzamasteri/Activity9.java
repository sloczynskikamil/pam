...
public class Activity9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button nextButton7 = findViewById(R.id.nextButton7);
        ...
        final View.OnClickListener nextButton3Listener = v -> callActivity10();
        nextButton7.setOnClickListener(nextButton3Listener);
    }

    private void callActivity10() {
        Intent nextIntent = new Intent(this, Activity10.class);
