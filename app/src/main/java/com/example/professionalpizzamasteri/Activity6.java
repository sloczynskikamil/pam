...
public class Activity6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button nextButton6 = findViewById(R.id.nextButton3);
        ...
        final View.OnClickListener nextButton3Listener = v -> callActivity7();
        nextButton6.setOnClickListener(nextButton3Listener);
    }

    private void callActivity7() {
        Intent nextIntent = new Intent(this, Activity7.class);
